...
// Test case1: The test input is a float data along with linked list pointers.  
    // Input: 3.2,head,tail
...
// Test case2: Testing invalid char input head->97->3.2->NULL
    // Input: 'b',head,tail
...
// Test case1: Basic deletion //List: 3.2->98->16->NULL
    ...
    // Actual Output: 3.2->98
// Test case2: Deletion from an empty list. 
    // Input: 
    // Expected Output:
    // Actual output:
